...
def main():
    ...
    parser.add_argument("--min_width", type=int, default=15, help="Minimum grid width (default: 15)")
    parser.add_argument("--max_width", type=int, default=50, help="Maximum grid width (default: 50)")
